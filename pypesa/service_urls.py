...
class sandbox:
    def __init__(self):
        ...
        self.single_stage_b2b = 'https://openapi.m-pesa.com:443/sandbox/ipg/v2/vodacomTZN/b2bPayment/'
        self.payment_reversal = 'https://openapi.m-pesa.com:433/sandbox/ipg/v2/vodacomTZN/reversal/'
...
class production:
    def __init__(self):
        ...
        self.single_stage_b2b = 'https://openapi.m-pesa.com:443/openapi/ipg/v2/vodacomTZN/b2bPayment/'
        self.payment_reversal = 'https://openapi.m-pesa.com:443/openapi/ipg/v2/vodacomTZN/reversal/'
